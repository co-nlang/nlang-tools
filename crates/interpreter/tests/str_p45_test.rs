...
fn test_str_encode_uri_special_chars() {
    ...
    let r = call(
        ...
        &mut ctx,
        "str.decode_uri",
        combo1(str_val("a%2Fb%3Fc%3Dd%26e%3Df")),
    );
...
fn test_str_levenshtein() {
    ...
    let r = call(
        ...
        &mut ctx,
        "str.levenshtein",
        combo2(str_val("kitten"), str_val("sitting")),
    );
    ...
    let r = call(
        ...
        &mut ctx,
        "str.levenshtein",
        combo2(str_val("hello"), str_val("hello")),
    );
...
fn test_str_word_count() {
    ...
    let r = call(
        ...
        &mut ctx,
        "str.word_count",
        combo1(str_val("  leading and trailing  ")),
    );
    assert_eq!(as_int(&r), 3);
}
