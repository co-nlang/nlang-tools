...
> 最後更新：2026-07-12（v0.2.2；REAL_05 conformance 48/48）  
> 測試數量：**762 passed / 0 failed / 3 ignored（113 個測試套件）**  
...
**總計：762 passed / 0 failed / 3 ignored（3 = 既存已知議題：深 thunk 堆疊、sibling 解析、隔離語境絕對路徑）**
